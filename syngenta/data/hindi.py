...
from .serializers import queryserializer,answerhindiSerializer
...
def get_object(id):
    obj=get_object_or_404(DataHindi,id=id)
    serializer=answerhindiSerializer(obj)
